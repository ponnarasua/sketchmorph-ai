...
const ImagesBoard = ({ image, rotation, xOffset, yOffset, zIndex, marginLeft, marginTop, removeImage }: Props) => {
    ...
    return (
        <div
            ...
            <div className="relative w-40 h-48 rounded-2xl overflow-hidden bg-white shadow-xl border border-border/20
               hover:scale-105 transition-all duration-200">
                ...
                <button 
                       ...
                       className='absolute top-2 left-2 w-6 h-6 bg-black/50 hover:bg-black/70 rounded-full flex items-center 
