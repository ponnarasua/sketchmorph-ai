...
const Navbar = () => {
        ...
        <div className="flex items-center gap-4">
            ...
            (!hasStyleGuide && (
                <div className="lg:inline-block hidden rounded-full text-primary/60 border
                   border-white/12 backdrop-blur-xl bg-white/8 px-4 py-2 text-sm
                    saturate-150">
    ...
    <div className='lg:flex hidden items-center justify-center gap-2'>
        <div className='flex items-center gap-2 backdrop-blur-xl bg-white/8 border 
          border-white/12 rounded-full p-2 saturate-150'>
            {tabs.map((t)=>(
                <Link 
                key={t.href}
                href={t.href}
                className={[
                    ...
                    ? 'bg-white/12 text-white font-medium border border-white/16 backdrop-blur-sm'
                    : 'text-zinc-400  hover:bg-white/6 hover:text-zinc-200 border border-transparent'
                ].join(' ')}
                >
                    <span
                     className={
       ...
       <div className='flex items-center gap-4 justify-end'>
        ...
        <Button 
          variant="secondary"
          className='rounded-full h-12 w-12 fle x items-center justify-center backdrop-blur-xl bg-white/8 
          border border-white/[0.012] saturate-150 hover:bg-white/12'
          
          >
            <CircleQuestionMark className='size-5 text-white' />

        </Button>
        <Avatar className='sizze-12 ml-2'>
