    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-lg">
        <div className="text-center mb-8">
          <div
            className="inline-flex items-center justify-center w-12 h-12 bg-linear-to-r
from-primary to-primary/60 rounded-full mb-4 shadow-lg"
          >
        ...
        <Card className="backdrop-blur-xl bg-white/8er border-white/12dow-xl saturate-150">
          <CardHeader className="text-center pb-4">
            ...
            <CardTitle className="ttext-2xl font-bold text-foreground mb-2">
              Standard Plan
            </CardTitle>
          ...
          <CardContent className="space-y-4 px-6">
            ...
            <div className="space-y-3">
              ...
              <div className="grid gap-2">
                <div
                  className="flex items-center gap-3 p-2 rounded-lg bg-white/5 border
              border-white/8"
                >
                  <div
                    className="w-6 h-6 bg-primary/20 rounded-md flex items-center justify-center
                     shrink-0"
                  >
                ...
                <div
                  className="flex items-center gap-3 p-2 rounded-lg bg-white/5er
                border-white/8"
                >
                  <div
                    className="w-6 h-6 bg-primary/20 rounded-md flex items-center justify-center
...
shrink-0 mt-0.5"
          ...
          <CardFooter className="flex flex-col gap-3 pt-4 px-6 pb-6">
            ...
            <p className="text-muted-foreground text-xs text-center">
              Cancel anytime . No setup fees . Instant acccess
            </p>
          </CardFooter>
        </Card>
